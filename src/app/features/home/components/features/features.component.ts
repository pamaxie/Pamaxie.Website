...
const features: { image: string, headerText: string, bodyText: string, link: string, buttonColor: string }[] = [
  {
    image: 'app/assets/images/feature-data-privacy-image.png',
  ...
  {
    image: 'app/assets/images/feature-data-detection-image.png',
  ...
  {
    image: 'app/assets/images/feature-safe-space-image.png',
  ...
  {
    image: 'app/assets/images/feature-improvements-image.png',
  ...
  {
    image: 'app/assets/images/feature-moderation-image.png',
  ...
  {
    image: 'app/assets/images/feature-open-source-image.png',
