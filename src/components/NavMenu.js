        ...
        return (
            <div className="h-12">
                <div className="fixed flex flex-row h-inherit w-full bg-tertiary z-40"
                    ...
                    <Dropdown id="nav"
                              innerHtml={
                                  <div slot="InnerHTML" className="flex flex-row flex-wrap content-center m-2">
                                      <svg className="flex-1-2 h-auto" width="8" height="8" viewBox="0 0 17 17"
                                           fill="none"
                              ...
                              content={
                                  <div slot="Content">
                                      <ul className="py-1" aria-labelledby="dropdownLargeButton">
                                          <li>
                                              <Link to={{pathname: "/"}}
                                                    className="block px-4 py-2 hover:bg-primary">Settings</Link>
                                          </li>
                                      </ul>
                                      <div className="py-1 border-t border-primary">
                                          <a onClick={this.logout} className="block px-4 py-2 cursor-pointer hover:bg-primary">Sign
                                              out</a>
                                      </div>
                                  </div>
                              }/>
                    ...
                    <div className="flex items-center absolute m-auto top-0 bottom-0 right-0"
