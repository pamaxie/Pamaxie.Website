    ...
    render(){
        return (
            <div className="flex flex-col m-3 bg-tertiary"
                ...
                <img src={this.image} alt="" className="w-full object-top object-cover overflow-hidden"
                     style={{maxHeight: '25.625rem'}}/>
                ...
                <Link className="m-4 p-2-4 w-fit rounded-full bg-secondary" style={{color: this.buttonColor}} to={{pathname: this.link}}>
                    Learn More
                </Link>
            </div>
        )
